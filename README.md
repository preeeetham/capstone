...
## Multi-Notebook Workflow (New)
The project now includes a modular notebook pipeline in [notebooks](notebooks):

1. [notebooks/00_project_configuration.ipynb](notebooks/00_project_configuration.ipynb)
2. [notebooks/01_data_loading_cleaning_validation.ipynb](notebooks/01_data_loading_cleaning_validation.ipynb)
3. [notebooks/02_eda_and_diagnostics.ipynb](notebooks/02_eda_and_diagnostics.ipynb)
4. [notebooks/03_baseline_models.ipynb](notebooks/03_baseline_models.ipynb)
5. [notebooks/04_arima_sarima.ipynb](notebooks/04_arima_sarima.ipynb)
6. [notebooks/05_prophet_modeling.ipynb](notebooks/05_prophet_modeling.ipynb)
7. [notebooks/06_lstm_gru_forecasting.ipynb](notebooks/06_lstm_gru_forecasting.ipynb)
8. [notebooks/07_tree_based_forecasting.ipynb](notebooks/07_tree_based_forecasting.ipynb)
9. [notebooks/08_unified_evaluation_and_comparison.ipynb](notebooks/08_unified_evaluation_and_comparison.ipynb)
10. [notebooks/09_final_forecast_and_export.ipynb](notebooks/09_final_forecast_and_export.ipynb)

Run them in sequence to generate cleaned data, forecasts, comparison charts, and final export files.
